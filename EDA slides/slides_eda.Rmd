...
## Particle count, average diameter, and coverage area
...
## Response: Particle coverage area
...
- **Baseline Handling:** At rotation = 0, retained area equals original deposited area and is treated as baseline
...
**Interpretation:** $\beta_1<0$ implies retained area decreases with rotation. A one–SD increase in rotation is associated with an average ~55% decrease in retained area $(e^{-0.79}\approx 0.45)$
]
